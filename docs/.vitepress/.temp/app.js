...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Coding Notes","description":"Coding notes.","base":"/coding-notes/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteTitle":"Coding Notes","nav":[{"text":"Home","link":"/"},{"text":"Algorithms","link":"/algorithms/"}],"sidebar":{"/algorithms/":[{"text":"Algorithms","link":"/algorithms/","items":[{"text":"Two Pointers","items":[{"text":"Leetcode 76 - Minimum Window Substring","link":"/algorithms/two-pointers/leetcode-76-minimum-window-substring"}]}]}]},"search":{"provider":"local"},"outline":{"label":"On this page","level":[2,3]}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.qqyzVA_N.js"));
